...
import '../viewmodel/cubit/fooddetailpage_cubit.dart';
                  ...
                  child: ExpansionPanelList(
                      ...
                      ExpansionPanel(
                        headerBuilder: (context, isExpanded) {
                          return Padding(
                            ...
                            child: ListTile(
                              title: Text("Malzemeler", style: Theme.of(context).textTheme.bodyMedium),
                            ),
                          );
                        },
                        body: Padding(
                        ...
                        isExpanded: context.read<FooddetailpageCubit>().expandedList[0],
                        canTapOnHeader: true,
                      ),
                      ExpansionPanel(
                        headerBuilder: (context, isExpanded) {
                          return Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: ListTile(
                              title: Text("Tarif", style: Theme.of(context).textTheme.bodyMedium),
                            ),
                          );
                        },
                        body: Padding(
                        ...
                        isExpanded: context.read<FooddetailpageCubit>().expandedList[1],
                        canTapOnHeader: true,
                      ),
                    ],
                    ...
                    expansionCallback: (panelIndex, isExpanded) {
                      context
                          ...
                          .openClose(context.read<FooddetailpageCubit>().expandedList[panelIndex], panelIndex);
                    },
                  ),
                ),
              ]),
