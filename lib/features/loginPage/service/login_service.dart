...
class LoginService {
  ...
  Future<User> signInWithEmailAndPassword(
    ...
    try {
      ...
      Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_) => const HomePageView()), (route) => false);
  ...
  Future signIn({required BuildContext context, required String? email, required String? password}) async {
    try {
      //Giriş Yapıldı
      await _firabaseAuth.signInWithEmailAndPassword(email: email!, password: password!);
