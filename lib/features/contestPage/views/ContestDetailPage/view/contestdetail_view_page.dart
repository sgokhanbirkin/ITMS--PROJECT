...
class ContestDetailPageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    TextStyle appbarTitleStyle = const TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: Colors.black);
    ...
    String _url = "https://galeri13.uludagsozluk.com/624/sarma-beyti_1776232.jpg";
    return Scaffold(
  ...
  Padding _buildImageOfContest(TextStyle kalanTimeTextStyle, BuildContext context, String _url) {
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
