...
import '../../../../core/constant/strings/contestDetail_strings.dart';
import '../../../../core/constant/strings/contestFinishDetail_strings.dart';
import '../../../../core/widgets/custom_button.dart';
import '../ContestPage/viewmodel/cubit/contesthomepage_cubit.dart';
...
class FinishedContestPageView extends StatelessWidget {
  ...
  final int? pageId;
  const FinishedContestPageView({Key? key, required this.model, required this.pageId}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle kalanTimeTextStyle = const TextStyle(color: Colors.grey, fontSize: 15, fontWeight: FontWeight.bold);
          ...
          return Scaffold(
            ...
            body: SingleChildScrollView(
              ...
              child: model != null
                  ? Column(
                      children: [
                        _buildImageOfContest(kalanTimeTextStyle, context, model),

                        _buildMiddleContent(context, appbarTitleStyle, bodyTitleStyle, bodyTextStyle, pageId, model),
  ...
  Padding _buildMiddleContent(BuildContext context, TextStyle? appbarTitleStyle, TextStyle? bodyTitleStyle,
      TextStyle? bodyTextStyle, int? pageId, ContestModel? model) {
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: Column(
        children: [
          Container(
            decoration: BoxDecoration(color: AppColors().green.withOpacity(1), borderRadius: BorderRadius.circular(10)),
            child: Row(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: SizedBox(height: 70, width: 70, child: Image.network(model?.badgeUrl.toString() ?? "")),
                ),
              ],
            ),
          ),
          if (pageId == 1)
            Padding(
                ...
                child: Column(
                  children: [
                    Text(model?.description ?? "", textAlign: TextAlign.center, style: bodyTitleStyle),
                    CustomButton(
                        text: " Yarışmaya Katıl",
                        isLoading: false,
                        func: () => Navigator.pushNamed(context, "/addFoodPage")),
                  ],
                )),
        ],
      ),
  ...
  Padding _buildImageOfContest(TextStyle kalanTimeTextStyle, BuildContext context, ContestModel? model) {
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(
                ContestFinishedDetailPageStrings.participantNumber + " kişi katıldı",
                style: kalanTimeTextStyle,
              )
            ],
          )
