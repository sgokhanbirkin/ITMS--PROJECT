...
import '../../../../../core/constant/strings/contestpage_strings.dart';
import '../../../model/contest_model.dart';
import '../viewmodel/cubit/contesthomepage_cubit.dart';
...
class ContestPageView extends StatelessWidget {
                ...
                ? SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildAwardContest(
                            bodyTitleStyle, context, context.read<ContesthomepageCubit>().awardContentList),
  ...
  Column _buildAwardContest(TextStyle bodyTitleStyle, BuildContext context, List<ContestModel>? list) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
