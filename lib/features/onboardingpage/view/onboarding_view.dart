...
class _OnboardingScreenState extends State<OnboardingScreen> {
          ...
          Padding(
            ...
            child: Text(
              ...
              style: Theme.of(context)
                  .textTheme
                  .bodyText1
                  ?.copyWith(color: isDark ? AppColors().white : AppColors().darkerGrey, fontWeight: FontWeight.bold),
            ),
          )
        ],
      ),
  ...
  CustomButton _buildCustomButton() {
    return CustomButton(
      func: selectedSlider == models.length - 1
      ...
      isLoading: false,
      text: selectedSlider == models.length - 1 ? OnBoardingStrings.buttonBasla : OnBoardingStrings.buttonIleri,
    );
  }
  ...
  AnimatedContainer buildSliderNav({required int index}) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
          color: selectedSlider == index ? const Color(0XFFff6a6a) : const Color(0xFFD7D7D7),
