...
import '../../../core/constant/strings/addFood_strings.dart';
import '../../../core/theme/color/color_theme.dart';
import '../../../core/widgets/custom_button.dart';
import '../viewmodel/cubit/foodadd_cubit.dart';
import '../../searchPage/model/cateory_card_model.dart';
                  ...
                  children: [
                                ...
                                for (var i = 0; i < 3; i++)
                                  InkWell(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Icon(context.read<FoodAddCubit>().icon[i]),
                                        Text(context.read<FoodAddCubit>().iconText[i])
                                      ],
                                    ),
                                  ),
                              ],
                    ...
                    DropdownButton(
                      ...
                      items: categories
                          ...
                          .toList(),
                      onChanged: (String? value) => context.read<FoodAddCubit>().changeSelectedCategory(value),
                      isExpanded: true,
                      hint: Text(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              padding: const EdgeInsets.only(bottom: 8.0, top: 8),
                              child: TextFormField(
                                controller: context.read<FoodAddCubit>().materialnameController,
                                decoration: InputDecoration(
                            ...
                            Container(
                              ...
                              padding: const EdgeInsets.only(bottom: 8.0, top: 8),
                              child: TextFormField(
                                controller: context.read<FoodAddCubit>().materialAmountController,
                                decoration: InputDecoration(
                                  hintText: AddFoodStrings.materialAmountHintText,
                                  hintStyle: Theme.of(context).textTheme.bodyMedium,
                                ),
                              ),
                            ),
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                            itemCount: context.read<FoodAddCubit>().materialList.length,
