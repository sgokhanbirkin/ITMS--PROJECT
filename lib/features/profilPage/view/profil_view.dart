...
import 'profile_your_receips_view.dart';
import 'saved_receips_view.dart';
...
class _ProfilPageViewState extends State<ProfilPageView> {
  ...
  SingleChildScrollView _buildReceipRow(BuildContext context, List<FoodModel> foodsList) {
        ...
        children: List.generate(foodsList.length, (index) {
          return Padding(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                    context, MaterialPageRoute(builder: (context) => FoodDetailPageView(foodModel: foodsList[index])));
              },
              child: SizedBox(
  ...
  Container _buildAchivementCard(BuildContext context) {
    return Container(
      decoration: BoxDecoration(borderRadius: context.normalBorderRadius, color: AppColors().red),
      child: SizedBox(
  ...
  Padding _buildAchivement(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(borderRadius: context.normalBorderRadius, color: AppColors().lead.withOpacity(0.1)),
        child: Column(
          ...
          children: [
            const FittedBox(
              child: CircleAvatar(
                backgroundImage:
                    NetworkImage("https://www.awardsaplus.com/wp-content/uploads/2016/08/ICON_achievement-icon.png"),
              ),
            ),
            SizedBox(
              height: context.paddingLow.top,
      ...
      children: [
          ...
          child: FittedBox(
            child: CircleAvatar(
              ...
              backgroundImage: NetworkImage(
                "https://www.antat.com.tr/assets/images/team/kad__n.png",
              ),
            ),
          ),
        ),
        Expanded(
          ...
          children: [
            ...
            const Spacer(),
            const Expanded(child: FittedBox(child: Text("Level 2"))),
